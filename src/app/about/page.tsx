  ...
  return (
    ...
    >
      <header className="mb-32">
        <span className="text-xs font-mono text-neutral-500 uppercase tracking-widest block mb-8">About</span>
      ...
      <section className="mb-32">
        <h2 className="text-sm font-mono text-neutral-500 uppercase tracking-widest mb-12">How I Work</h2>
        <div className="space-y-16">
          {[
            ...
            { title: "Distribution Matters", desc: "A product unseen is unfinished. I build with growth and metrics in mind." }
             ...
             >
                <h3 className="text-lg text-white font-medium mb-2">{principle.title}</h3>
                <p className="text-neutral-400 font-light">{principle.desc}</p>
             </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-32">
        <h2 className="text-sm font-mono text-neutral-500 uppercase tracking-widest mb-12">Capabilities</h2>
        
        <div className="grid gap-16">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <h3 className="text-white text-lg font-medium mb-4">Software Engineering</h3>
            <ul className="text-neutral-300 font-light space-y-2 mb-6">
            ...
            <p className="text-xs text-neutral-600 font-mono leading-relaxed max-w-lg">
              Next.js, Go, TypeScript, Python, Django, REST, gRPC, Redis, BigQuery, Docker, AWS, GCP, Monorepos, Microservices
            </p>
          </motion.div>

          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <h3 className="text-white text-lg font-medium mb-4">Design & Visual Systems</h3>
            <ul className="text-neutral-300 font-light space-y-2 mb-6">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            <h3 className="text-white text-lg font-medium mb-4">Marketing & Distribution</h3>
            <ul className="text-neutral-300 font-light space-y-2 mb-6">
      ...
      <section className="mb-32">
        <h2 className="text-sm font-mono text-neutral-500 uppercase tracking-widest mb-8">Work Context</h2>
      ...
      <section className="border-t border-white/10 pt-16 flex flex-col items-start gap-8">
         <p className="text-white font-medium text-lg">
            I’m most useful where design, engineering, and scale intersect.
         </p>
         <Link href="/work" className="text-neutral-400 hover:text-white transition-colors flex items-center gap-2 border-b border-transparent hover:border-white pb-0.5">
